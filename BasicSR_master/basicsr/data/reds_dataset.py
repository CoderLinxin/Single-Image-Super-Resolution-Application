...
class REDSDataset(data.Dataset):
    ...
    reds 数据集每个序列有100帧,但窗口数并不是100帧,而是5帧
    训练策略为: 每个序列有100帧,对应100个索引在一个epoch中会遍历这100个索引对应训练100次,以每次输入网络5帧为例:
    00000000、00000001、00000098、00000099 这四帧无法作为中间帧,故遍历到这四个索引时重新随机选取一个合法的中间帧进行训练
    000000002~00000097 可以作为中间帧,对他们进行训练
    ...
    def __init__(self, opt):
        ...
        with open(opt['meta_info_file'], 'r') as fin:
            for line in fin:
                ...
                # [000/00000000,000/00000001,...,000/00000099,001/00000000,...]
    ...
    def __getitem__(self, index):
        ...
        # determine the neighboring frames(确定相邻帧的间隔(默认为1))
        ...
        while (start_frame_idx < 0) or (end_frame_idx > 99):  # 超出边界则重新筛选直到不超出边界
            # 重新选取合法的中间帧索引,由于 interval, num_half_frames 可变,故随机区间设置 [0,99) 即可
